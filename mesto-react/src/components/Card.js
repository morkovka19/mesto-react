    ...
    render(){
        return(
            <>
                ...
                {this.props.info.owner._id === this.context._id && <button className="elements__trash" type="submit" onClick={this.handleCardDelete}></button>}
                <div className="elements__item-block">
                    ...
                    <div className="elements__block-like">
                        <button type="button" className={`elements__btn-like ${this.props.info.likes.some(item => item._id === this.context._id) && 'elements__btn-like_active'}`}  onClick={this.handleCardLike} ></button>
