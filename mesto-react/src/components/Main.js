            ...
            <main className="main">
                <section className="profile root__container-center">
                    <div className="profile__block-author">
                        <img className="profile__avatar" src={this.context?.avatar} alt="фото автора" />
                    ...
                    <ul className="elements__group">
                        {this.props.cards.map((card, i) => (
                            <li className="elements__item" key={card._id}>
                                <Card info={card} onCardClick={this.props.onCardClick} onCardLike={this.props.onCardLike} onCardDelete={this.props.onCardDelete}/>
                            </li>
                        ))}
                    </ul>
                </section>
